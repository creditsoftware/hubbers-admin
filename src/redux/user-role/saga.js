...
import { CREATE_USER_ROLE, GET_ALL_USER_ROLES, GET_USER_ROLE, UPDATE_USER_ROLE, DELETE_USER_ROLE} from '../types/user-role';
...
function* AllUserRoles() {
  try {
    ...
    if(result.status === 200 && result.statusText === 'OK') {
      ...
      yield put(getAllUserRolesError('Get All UserRoles Response is not success!'))
    }
  } catch (error) {
