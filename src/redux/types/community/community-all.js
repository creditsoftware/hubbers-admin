...
export const GET_COMMUNITY_LIST_BY_ROLE_SUCCESS = 'GET_COMMUNITY_LIST_BY_ROLE_SUCCESS';
export const GET_COMMUNITY_LIST_BY_ROLE_ERROR = 'GET_COMMUNITY_LIST_BY_ROLE_ERROR';
