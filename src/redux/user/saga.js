...
import { CREATE_USER, GET_ALL_USER, GET_USER, UPDATE_USER, DELETE_USER, GET_ALL_USER_SUCCESS, GET_ALL_USER_ERROR } from '../types/user';

import { getAllUsersSuccess, getAllUsersError, getUsersSuccess, getUsersError } from './actions';
